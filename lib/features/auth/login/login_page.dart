          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                onChanged: presenter.handleUpdateUserName,
              ),
              ...
              TextField(
                ...
                onChanged: presenter.handleUpdatePassword,
              ),
              const SizedBox(height: 16),
              stateObserver(
                builder: (context, state) => ElevatedButton(
                  onPressed: state.isLoginEnabled ? presenter.handleLogin : null,
                  child: Text(appLocalizations.logInAction),
                ),
              ),
              stateObserver(
                builder: (context, state) => state.isLoading ? const CircularProgressIndicator() : Container(),
              ),
            ],
          ),
        ),
