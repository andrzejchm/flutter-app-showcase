  ...
  Future<void> onLogin() async {
    await logInUseCase
        ...
        .asyncFold(
          ...
          (success) => _showSuccessDialog(success.username),
        );
  }

  void _showSuccessDialog(String username) => navigator.showAlert(
        title: appLocalizations.loginSuccessTitle(username),
